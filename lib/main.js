(function() {
  var EncodeFormView, Encoder, spawn,
  ...
  Encoder = (function() {
    ...
    function Encoder(_arg) {
      ...
      require("fs").chmodSync(this.pathToBin, 0755);
    }

    Encoder.prototype.pathToBin = "vendor/bin/osx/shineenc";
    ...
    Encoder.prototype.process = function() {
      ...
      return this.child.on("exit", function(code) {
        return _this.log("Encoding process existed with code: " + code);
      });
    };
